...
const configs = (theme, loadImage) => {
    ...
    loadImage = loadImage || {
        path: "http://127.0.0.1:9000/dash.local/louis-magnotti-YvCg5X3pWzc-unsplash.jpg",
...
const EditorImage = (props) => {
    ...
    if (editorInstance !== null) {
        ...
        /* setTimeout(() => {
            editorInstance
                .loadImageFromURL(
                    "https://images.unsplash.com/photo-1614081620293-6ea261f4d9a7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000",
                    "dogs.jpg"
                )
                .then((result) => {
                    console.log(
